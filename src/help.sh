show_help() {
    ...
    *)
        ...
        msg "文档(doc) $(msg_ul https://xkd333.com/$is_core/$is_core-script/)"
        ;;
...
about() {
    ...
    unset c n m s b
    msg
    msg "网站: $(msg_ul https://xkd333.com)"
    msg "频道: $(msg_ul https://t.me/tg2333)"
    msg "群组: $(msg_ul https://t.me/tgxkd333)"
    msg "Github: $(msg_ul https://github.com/${is_sh_repo})"
    msg "Twitter: $(msg_ul https://twitter.com/aixkd333)"
